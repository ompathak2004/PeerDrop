...
const adjectives = [
    'happy', 'quick', 'bright', 'clever', 'brave',
    'swift', 'silent', 'cosmic', 'noble', 'mighty'
];

const nouns = [
    'dolphin', 'rabbit', 'eagle', 'tiger', 'phoenix',
    'dragon', 'falcon', 'panther', 'wolf', 'lion'
];
...
export const PeerConnection = {
    ...
    startPeerSession: () => new Promise<string>((resolve, reject) => {
        try {
            peer = new Peer(generateReadableId())
            peer.on('open', (id) => {
